defmodule Issues.TableFormatter do
  ...
  each header. That is, each header identifies a column, and those columns
  ...
  @doc """
  Given a list of rows, where each row is a keyed list of columns, return
  a list containing lists of the data in each column. The 'headers' parameter
  contains the list of colums to extract.
